...
<body>
  ...
  <main role="main" class="container">
    ...
    <form action="validation.php" method="post">
      ...
      <div class="form-group">
        <label for="author">Auteur <span style="color: red; font-weight: bold;">*</span></label>
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" id="content" name="content" placeholder="Description du contenu de l'article" rows="3" required="required"></textarea>
      </div>
    ...
    <h2 class="mt-5 mb-5">Liste des articles</h2>
